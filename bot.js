...
client.on("message", message => {
 ...
 if (message.content === "^^help") {
  ...
  const embed = new Discord.RichEmbed()
      ...
      .addField("『ESK_ON#7991』『مصمم البوت』", true)
...
القسم الثالث مصمم البوت | @ESK_ON#7991 
...
if (message.content.startsWith('^^bcall')){
 if (message.author.id !== '541650984334786562') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
